...
Создай файл docker-compose.yml в корне проекта, чтобы не захламлять Windows-машину серверами.
...
- Давать осмысленные имена функциям, так как они будут отображаться в логах.
